"""
Итератор (iterator).
Это интерфейс, который даёт доступ к элементам коллекции (массива или контейнера), а также навигацию по ним.
В зависимости от конкретной системы итераторы носят разные названия.
Если говорить о системах управления, то это курсоры.
"""
import copy
