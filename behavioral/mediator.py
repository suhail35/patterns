"""
Посредник (Mediator).
Данный паттерн проектирования позволяет обеспечить взаимодействие нескольких объектов.
В процессе этого создаётся слабая связанность и объекты избавляются от потребности в явных ссылках друг на друга.
"""
